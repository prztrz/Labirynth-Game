...
import { tutorialTiles } from "../objects/tutorialTiles.js";
 ...
 */
class TutorialBoard extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            ...
            newTileTop: 0,
            newTileRotation: '',
            tiles: tutorialTiles, //Array of objects representing tiles on the board, created when Board component is mounted or updated
    ...
    componentDidMount() {
        this.getTargetTiles(this.state.tiles)
